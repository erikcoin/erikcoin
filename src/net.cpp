...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Erikcoin " + FormatFullVersion();
...
//    {"erikcointools.com", "dnsseed.erikcointools.com"},
//    {"erikcoinpool.org", "dnsseed.erikcoinpool.org"},
//    {"xurious.com", "dnsseed.ERIC.xurious.com"},
...
//   {"erikcointools.com", "testnet-seed.erikcointools.com"},
//    {"xurious.com", "testnet-seed.ERIC.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Erikcoin is probably already running."), addrBind.ToString().c_str());
        else
