...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("042c6970da340da261778f6dee5d0cb0a9f2def7e90086a2accf0a86f5865aa04b3e722b3566859de419ff26ca75a3a998b3dc854f61204f09b967ff0af7a5d16e") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 2 * 60; // Erikcoin: 1 minutes
        consensus.nPowTargetSpacing = 1 * 60;  //Erikcoin: 1 minutes

        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 150; // 75% of 8064 
...
//        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.erikcoin.loshan.co.uk", true));
//       vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
//       vSeeds.push_back(CDNSSeedData("erikcointools.com", "dnsseed.erikcointools.com"));
//        vSeeds.push_back(CDNSSeedData("erikcoinpool.org", "dnsseed.erikcoinpool.org"));
