...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/erikcoin-project/erikcoin>";
    const std::string URL_WEBSITE = "<https://erikcoin.org>";
